...
def _create_demo_details_for_header(run_card_id: int):
	demo_details = [
	    (1, 'CNC加工', 'CNC-STEP-01', 'CNC', 'CNC-01', ...),
	    (2, 'CNC加工', 'CNC-STEP-02', 'CNC', 'CNC-02', ...),
	    (3, 'CNC加工', 'CNC-STEP-03', 'CNC', 'CNC-03', ...),
	    (4, 'CNC加工', 'CNC-STEP-04', 'CNC', 'CNC-01', ...),
	    (5, 'CNC加工', 'CNC-STEP-05', 'CNC', 'CNC-02', ...),
	    (6, 'CNC加工', 'CNC-STEP-06', 'CNC', 'CNC-03', ...),
	    (7, 'CNC加工', 'CNC-STEP-07', 'CNC', 'CNC-01', ...),
	    (8, 'CNC加工', 'CNC-STEP-08', 'CNC', 'CNC-02', ...),
	]
    created = 0
