...
def _create_demo_details_for_header(run_card_id: int):
    demo_details = [
        (1, '磨床', None, 'GRINDING', 'GRIND-01', 100, 0, '厚度 111(+0.01/0)', '人工量測', 60, 0, False, 0, 4.2, 5.2, 0.1, 'PENDING'),
        (2, 'CNC銑床', 'O3391', 'CNC', 'CNC-01', 100, 0, 'G1F-01 / G1H-01 / G1H-02', '機台自動帶入量測值', 45, 0, False, 0, 6.2, 7.5, 0.12, 'PENDING'),
        (3, 'CNC銑床', 'O3392', 'CNC', 'CNC-02', 100, 0, 'G4F-02 / G4F-03', '機台自動帶入量測值', 55, 15, True, 15, 3.1, 8.1, 0.2, 'PENDING'),
        (4, '手工處理', None, 'MANUAL', None, 100, 0, '去毛邊 / 外觀處理', '人工確認', 30, 0, False, 0, None, None, 0.08, 'PENDING'),
        (5, '拋光', None, 'POLISH', None, 100, 0, '第一段 / 第二段 / 轉速', '人工確認', 40, 0, False, 0, None, None, 0.1, 'PENDING'),
        (6, '成品檢驗', None, 'QC', None, 100, 0, '外觀 / 三次元', 'QC 量測', 50, 0, False, 0, None, None, 0.15, 'PENDING'),
        (7, '清洗包裝', None, 'CLEAN_PACK', None, 100, 0, '純水 / 超音波 / 烘乾', '人工確認', 35, 0, False, 0, None, None, 0.05, 'PENDING'),
        (8, '成品入庫', None, 'WAREHOUSE', None, 100, 0, '成品入庫', '入庫確認', 20, 0, False, 0, None, None, 0.03, 'PENDING'),
    ]
    created = 0
