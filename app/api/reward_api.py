    ...
    try:
        ...
        return fetch_all(
            ...
            SELECT
                ...
                ROUND(COALESCE(actual_oee, 0)::numeric, 3) AS oee_improvement_rate,
                ...
                ROUND(COALESCE(actual_oee, 0)::numeric, 3) AS actual_oee,
                ROUND(COALESCE(actual_yield_rate, 0)::numeric, 3) AS actual_yield_rate,
